...
In this lesson we'll to focus on space complexity and see how the same notations we've already learned can be used to measure how a change in input for our algorithms can affect the amount of memory it uses.

When we talk about memory. We mean primary memory which is the working memory available to your system to execute algorithms. You can read about this [here](https://www.geeksforgeeks.org/primary-memory/)
